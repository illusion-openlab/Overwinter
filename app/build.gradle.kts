...
android {
    namespace = "tech.illusion.overwinter"
    compileSdk = 35

    defaultConfig {
        applicationId = "tech.illusion.overwinter"
        minSdk = 35
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // tooling 只在预览时需要；放在 implementation 会把它的传递依赖
    // androidx.compose.material 一起带进 release 包，违反本项目「禁 Material」的硬规则
